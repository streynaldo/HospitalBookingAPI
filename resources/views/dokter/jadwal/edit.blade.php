<x-admin.layout title="Edit Jadwal Dokter">
    {{-- Title Atas --}}
    <div class="mb-4 flex items-center justify-between">
        <h1 class="text-2xl md:text-4xl font-semibold text-gray-900 dark:text-gray-100">Edit Jadwal Dokter</h1>
    ...
    <div class="p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form action="{{ route('admin.dokter.jadwal.update', [$dokter->id,$jadwal->id]) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="time" id="jam_mulai" name="jam_mulai" value="{{ $jadwal->jam_mulai }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
            </div>
            <div class="mb-4">
                <label for="jam_selesai" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Jam Selesai</label>
                <input type="time" id="jam_selesai" name="jam_selesai" value="{{ $jadwal->jam_selesai }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
            </div>
