<x-admin.layout title="Tambah Dokter">
    ...
    <div class="mb-4 flex items-center justify-between">
        <h1 class="text-2xl md:text-4xl font-semibold">Tambah Dokter Baru</h1>
        <a href="{{ route('admin.dokter.index') }}"
            class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">Kembali</a>
    </div>

    {{-- Form --}}
    <form action="{{ route('admin.dokter.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        @csrf
        {{-- Nama --}}
        <div>
        ...
        <div>
            ...
            <input type="text" name="spesialis" id="spesialis" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" required>
        </div>
        ...
        <div>
            ...
            <img id="foto-preview" class="mt-2 max-h-32 rounded-md hidden" alt="Foto Preview">
        </div>
